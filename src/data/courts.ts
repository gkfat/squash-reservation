...
export const COURTS: Court[] = [
    ...
    {
        city: '台北市 | Taipei City',
        title: '內湖運動中心 | Taipei NeiHu Sports Center',
    ...
    {
        city: '台北市 | Taipei City',
        title: '北投運動中心 | Taipei BeiTou Sports Center',
        address: '台北市北投區石牌路一段39巷100號',
        phone: '(02) 2820-2880',
    },
    {
        city: '台北市 | Taipei City',
        title: '南港運動中心 | Taipei NanGang Sports Center',
        address: '台北市南港區玉成街69號',
        phone: '(02) 2653-2279',
    },
    {
        city: '台北市 | Taipei City',
        title: '信義運動中心 | Taipei XinYi Sports Center',
